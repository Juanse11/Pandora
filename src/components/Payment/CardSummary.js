  ...
  <Container>
    <Item style={{ padding: 0 }}>
      <Box style={{ marginTop: 0 }}>
        <PostTitle>Establecimiento Spurs New Stadium - Soledad</PostTitle>
    ...
    <Item>
      <Box style={{ padding: 0 }}>
        <ItemText style={{ marginBottom: "6px" }}>domingo, 26 de mayo</ItemText>
        <ItemText style={{ marginBottom: "6px" }}>14:30 - 20:00</ItemText>
      </Box>
    </Item>
    <Divider style={{ margin: "16px 0" }} />
    <Item>
      <ItemText>$371,715 por 1 hora</ItemText>
      <ItemText style={{ marginLeft: "auto" }}>$371,715</ItemText>
    </Item>
    <Divider style={{ margin: "16px 0" }} />
    <Item>
    ...
    <Item>
      <Box>
        <ItemText style={{color: '#483df6', marginBottom: '8px'}} >Politica de cancelación</ItemText>
        <ItemText style={{ fontSize: '14px' }}>
          Obtén un reembolso completo si cancelas durante las 2 horas
          siguientes al pago.
        </ItemText>
      </Box>
    </Item>
